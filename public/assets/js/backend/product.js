            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        { field: 'productcategory.name', title: __('产品分类'), operate: 'LIKE' },
                        ...
                        {
                            field: 'buttons', title: __('物模型'), table: table, events: Table.api.events.operate, formatter: Table.api.formatter.buttons, buttons: [
                                {
                                    name: 'detail',
                                    text: __('编辑'),
                                    title: __('物模型详情'),
                        ...
                        {
                            field: 'buttons', title: __('设备'), table: table, events: Table.api.events.operate, formatter: Table.api.formatter.buttons, buttons: [
                                {
                                    name: 'detail',
                                    text: __('查看'),
                                    title: __('设备详情'),
