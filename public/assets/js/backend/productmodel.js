define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'productmodel/index' + location.search,
                    add_url: 'productmodel/add',
                    edit_url: 'productmodel/edit',
                    del_url: 'productmodel/del',
                    multi_url: 'productmodel/multi',
                    import_url: 'productmodel/import',
                    table: 'productmodel',
                }
            });
